...
public final class AdoptAgent extends TreeNodeAgent{
	...
	public AdoptAgent(int id, String name, int[] domain, int[] neighbours,
	...
	public Object printResults(List<Map<String, Object>> results) {
		...
		{
			int id_=(Integer) result.get(AdoptAgent.ID);
			String name_=(String) result.get(AdoptAgent.NAME);
			int value_=(Integer) result.get(AdoptAgent.VALUE);
			int LB_=(Integer) result.get(AdoptAgent.LB);
			int UB_=(Integer) result.get(AdoptAgent.UB);
			int TH_=(Integer) result.get(AdoptAgent.TH);
			int ncccTemp=(Integer) result.get(AdoptAgent.NCCC);
			if(maxNccc<ncccTemp)
			{
				maxNccc=ncccTemp;
			}
