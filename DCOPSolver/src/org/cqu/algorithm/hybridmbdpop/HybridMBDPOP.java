...
import org.cqu.algorithm.hybriddpop.HybridDPOPMessageTypes;
...
public class HybridMBDPOP extends TreeNodeAgent{
	...
	public HybridMBDPOP(int id, String name, int[] domain, int[] neighbours,
	...
	private void startFromLeaf()
	{
		...
		{
			MultiDimensionData mdData=localMDDatas.get(parent).shrinkDimension(this.id+"", this.contextWrapped.getValueIndex(this.id));
