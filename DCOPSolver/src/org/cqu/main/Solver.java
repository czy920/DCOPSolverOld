...
import org.cqu.common.ResultDPOP;
import org.cqu.core.control.synchronous.AgentManagerCycle;
import org.cqu.core.control.synchronous.MessageMailerCycle;
import org.cqu.gui.settings.Settings;
import org.cqu.problem.parser.Problem;
import org.cqu.problem.parser.ProblemParser;
...
import org.cqu.varOrdering.dfs.DFSgeneration;
...
public class Solver {
	...
	{
		//parse problem xml
		TreeGenerator.PseudoTreeType pseudotreeType=null;
		if(agentType.equals("BFSDPOP"))
		{
			pseudotreeType=TreeGenerator.PseudoTreeType.BFS;
		}else
		{
			pseudotreeType=TreeGenerator.PseudoTreeType.DFS;
		}
		
		Problem problem=new PseudotreeProblem();
		...
		{
			//construct agents
			AgentFactory agentManager=new AgentFactory(problem, agentType);
	...
	private void batSolveEach(String problemPath, String agentType, final AtomicBoolean problemSolved)
	{
		TreeGenerator.PseudoTreeType pseudotreeType=null;
		if(agentType.equals("BFSDPOP"))
		{
		...
		//采用同步消息机制的算法
		if(agentType.equals("BNBADOPT")||agentType.equals("ADOPT_K")||agentType.equals("BDADOPT")||agentType.equals("SynAdopt1")||agentType.equals("SynAdopt2"))
