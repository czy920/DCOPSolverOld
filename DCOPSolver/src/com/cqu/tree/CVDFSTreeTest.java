...
public class CVDFSTreeTest {
	...
	public static void main(String[] args) {
		...
		CVDFSTree cvdfsTree=new CVDFSTree(neighbors);
		cvdfsTree.generate();
		...
		TreeFrame treeFrame=new TreeFrame(DFSTree.toTreeString(names, cvdfsTree.getParents(), cvdfsTree.getChildren()));
